...
class MyController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
          ...
          $buku->save();
          return redirect('/')->with('berhasil', 'Buku telah ditambahkan'); 
    }
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
          ...
          return redirect('/')->with('berhasil', 'Buku berhasil di update');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/')->with('berhasil', 'Buku telah dihapus');
    }
